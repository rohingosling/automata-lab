...
import { readButtonColor } from "../../application/button-colors.js";
import
{
...
//--------------------------------------------------------------------------------------------------
// Function: readSolverDefaultReviewTab
//
// Description:
//
//   Accepts supported Solver review views and falls back for absent or invalid stored values.
//
//--------------------------------------------------------------------------------------------------

function readSolverDefaultReviewTab ( value: unknown ): ApplicationPreferences["solverDefaultReviewTab"]
{
    switch ( value )
    {
        ...
        case "solver-candidate-comparison":
            return value;
        default:
            return DEFAULT_APPLICATION_PREFERENCES.solverDefaultReviewTab;
    }
}
...
export function parseApplicationPreferences ( value: unknown ): ApplicationPreferences
{
    ...
    return {
        titleBarColor: readButtonColor (
            value [ "titleBarColor" ], DEFAULT_APPLICATION_PREFERENCES.titleBarColor,
        ),
        applicationButtonColor: readButtonColor (
            value [ "applicationButtonColor" ], DEFAULT_APPLICATION_PREFERENCES.applicationButtonColor,
        ),
        consoleMessageButtonColor: readButtonColor (
            value [ "consoleMessageButtonColor" ], DEFAULT_APPLICATION_PREFERENCES.consoleMessageButtonColor,
        ),
        matchConsoleMessageColor: readBoolean (
            value [ "matchConsoleMessageColor" ], DEFAULT_APPLICATION_PREFERENCES.matchConsoleMessageColor,
        ),
        ...
        simulatorEnableTerminalStates: readBoolean (
            value [ "simulatorEnableTerminalStates" ], DEFAULT_APPLICATION_PREFERENCES.simulatorEnableTerminalStates,
        ),
        simulatorFollowTraceTail: readBoolean (
            value [ "simulatorFollowTraceTail" ], DEFAULT_APPLICATION_PREFERENCES.simulatorFollowTraceTail,
        ),
        snapToGrid: readBoolean ( value [ "snapToGrid" ], DEFAULT_APPLICATION_PREFERENCES.snapToGrid ),
        solverDefaultReviewTab: readSolverDefaultReviewTab ( value [ "solverDefaultReviewTab" ] ),
