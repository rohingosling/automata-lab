...
import type { ButtonColor } from "../button-colors.js";
...
// Description:
//
//   Defines the supported Solver candidate review views and their persisted preference values.
//
//--------------------------------------------------------------------------------------------------
...
{
    readonly titleBarColor:             ButtonColor;
    readonly applicationButtonColor:    ButtonColor;
    readonly consoleMessageButtonColor: ButtonColor;
    readonly matchConsoleMessageColor:  boolean;
    ...
    readonly simulatorEnableTerminalStates: boolean;
    readonly simulatorFollowTraceTail: boolean;
    readonly snapToGrid:           boolean;
    readonly solverDefaultReviewTab: CandidateReviewTab;
