...
export interface ServerGateway
{
    ...
    startSession ( executionPolicy: RuntimeExecutionPolicy ): Promise<ServerGatewayResult<HostedSessionDto>>;
    runSession (
    ...
    resetSession ( sessionId: string, executionPolicy: RuntimeExecutionPolicy ): Promise<ServerGatewayResult<HostedSessionDto>>;
