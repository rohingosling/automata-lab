...
function copyRuntimeSession ( runtimeSession: RuntimeSession ): RuntimeSession
{
    ...
    return {
        ...runtimeSession,
        executionPolicy: { ...runtimeSession.executionPolicy },
        executionStatus: { ...runtimeSession.executionStatus },
...
export class SimulationSessionRepository
{
    ...
    public create ( sessionId: string, hostedModel: HostedModelSnapshot,
        executionPolicy: RuntimeExecutionPolicy = { enableTerminalStates: false } ): CreateSimulationSessionResult
    {
        ...
        const session: SimulationSessionRecord =
        {
            ...
            runtimeSession:      resetRuntimeSession ( hostedModel.compiledModel, executionPolicy ),
    ...
    public reset ( sessionId: string,
        executionPolicy: RuntimeExecutionPolicy = { enableTerminalStates: false } ): SimulationSessionRecord | null
    {
        // Initialize the local values needed by this operation.
        ...
        const resetSession: SimulationSessionRecord =
        {
            ...session,
            processedEventCount: 0,
            runtimeSession:      resetRuntimeSession ( session.hostedModel.compiledModel, executionPolicy ),
            traceTruncated:      false,
        };
