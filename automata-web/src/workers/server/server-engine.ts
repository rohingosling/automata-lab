    ...
    private async dispatch ( request: ServerRequestEnvelope ): Promise<readonly ServerOutboundEnvelope[]>
    {
        ...
        switch ( request.operation )
        {
            ...
            case "simulation.start":
                ...
                return this.fromStateResult ( request, this.serverState.startSession ( request.payload ) );
            ...
            case "simulation.reset":
                ...
                return this.fromStateResult ( request, this.serverState.resetSession ( request.sessionId, request.payload ) );
