...
function decodeDraftTransition ( value: unknown ): ChartDraftTransition | null
{
    ...
    const transition = exactRecord ( value, [ "id", "source", "target" ], [ "sourceState", "targetState", "rememberedEvent", "rememberedTransitionIndex" ] );
    ...
    if ( sourceState != null && typeof sourceState !== "string" ||
