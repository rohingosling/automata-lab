...
export function AboutDialog ( properties: BasicDialogProperties )
{
    ...
    return (
        ...
        >
            ...
            <p>
                <a href="https://github.com/rohingosling/automata-lab" rel="noopener noreferrer" target="_blank">
                    { text ( "dialog.about.repository" ) }
                </a>
            </p>
            <Tabs
                activeTab = { activeTab }
...
{
    readonly entityKind:   "action" | "event" | "state";
...
export function NamedEntityDialog ( properties: NamedEntityDialogProperties )
{
    ...
    return (
        <ModalDialog
            ...
            open                 = { properties.open }
            title                = { text ( `dialog.entity.${properties.mode}.${properties.entityKind}` ) }
        ...
        >
            ...
            { value.terminalState !== undefined && (
                <FormField label={ text ( "field.terminalState" ) } name="entity-terminal-state">
                    <input
                        checked  = { value.terminalState }
                        id       = "entity-terminal-state"
                        onChange = { event => setValue ( { ...value, terminalState: event.currentTarget.checked } ) }
                        type     = "checkbox"
                    />
                </FormField>
            ) }
...
export function TransitionDialog ( properties: TransitionDialogProperties )
{
    ...
    return (
        <ModalDialog
            ...
            onRequestClose       = { closeAndReset }
            open                 = { properties.open }
            title                = { text ( `dialog.transition.${properties.mode}.title` ) }
...
export function ImpactConfirmationDialog ( properties: ImpactConfirmationDialogProperties )
{
    ...
    const chartReferenceCount = ( properties.impact.chartDraftEndpointAttachmentCount ?? 0 ) +
        ( properties.impact.chartDraftEventReferenceCount ?? 0 ) +
        properties.impact.chartInitialIndicatorCount +
...
export function SolverSequenceDialog ( properties: SolverSequenceDialogProperties )
{
    ...
    return (
        <ModalDialog
            ...
            onRequestClose       = { properties.onClose }
            open                 = { properties.open }
            title                = { text ( `dialog.solverSequence.${properties.mode}.title` ) }
...
export function SimulatorSequenceDialog ( properties: SimulatorSequenceDialogProperties )
{
    ...
    return (
        <ModalDialog
            ...
            onRequestClose       = { properties.onClose }
            open                 = { properties.open }
            title                = { text ( `dialog.simulatorSequence.${properties.mode}.title` ) }
