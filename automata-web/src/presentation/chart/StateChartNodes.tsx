...
import type { ChartIndicatorReference, ChartPoint } from "../../domain/model/contracts.js";
import { CHART_INDICATOR_SYMBOL_DIAMETERS } from "./chart-projection.js";
...
export function StateChartIndicatorNodeComponent ( properties: NodeProps<StateChartIndicatorNode> )
{
    ...
    const symbolDiameter = CHART_INDICATOR_SYMBOL_DIAMETERS [ properties.data.kind ];
    ...
    return (
        ...
        >
            ...
            <span aria-hidden="true" className="chart-indicator-symbol"
                style={ { height: symbolDiameter, width: symbolDiameter } } />
        </div>
    );
}
