            ...
            >
                { section.draftTransitions.map ( row => (
                    <tr key={ row.id }>
                        ...
                        <td>{ row.sourceState == null ? `${row.sourceX}, ${row.sourceY}` : `${row.sourceState} (${row.sourceX}, ${row.sourceY})` }</td>
                        <td>{ row.targetState == null ? `${row.targetX}, ${row.targetY}` : `${row.targetState} (${row.targetX}, ${row.targetY})` }</td>
                    </tr>
                ) ) }
            </ReportTable>
        </section>
