...
// Description:
//
//   Owns explicit terminal membership independently of events, actions, and Chart notation.
//
//--------------------------------------------------------------------------------------------------

export interface StateDefinition extends NamedEntity
{
...
export type ChartIndicatorReference = { readonly kind: "initial" } | { readonly kind: "terminal"; readonly id: number };

export interface ChartIndicatorTransition
{
    readonly id:     number;
    readonly source: ChartIndicatorReference;
    readonly target: ChartIndicatorReference;
}
...
export interface ChartDraftTransition
{
    ...
    readonly sourceIndicator?: ChartIndicatorReference | null;
    readonly targetIndicator?: ChartIndicatorReference | null;
...
{
    readonly indicatorTransitions?:   readonly ChartIndicatorTransition[];
...
export interface FileDocumentV1
{
    ...
    readonly file_version: "1.0.0" | "1.1.0" | "1.2.0" | "1.3.0";
    readonly settings:
    {
        readonly name:        string;
        readonly description: string;
    ...
    readonly chart:
    {
        ...
        readonly indicators:
        {
            ...
            readonly indicator_transitions?: readonly ChartIndicatorTransition[];
        ...
        readonly draft_transitions?: readonly {
            ...
            readonly source_indicator?: ChartIndicatorReference | null;
            readonly target_indicator?: ChartIndicatorReference | null;
            readonly source_state?: string | null;
            readonly target_state?: string | null;
            readonly remembered_event?: string | null;
            readonly remembered_transition_index?: number | null;
        }[];
    };
    readonly solver:
    {
...
//--------------------------------------------------------------------------------------------------
// Type: FileDocumentV1_4
//
// Description:
//
//   Extends the 1.3.0 file shape with required, explicitly mapped state terminal booleans.
//   Earlier version contracts remain unchanged.
//
//--------------------------------------------------------------------------------------------------

export interface FileStateDefinitionV1_4 extends FileNamedEntityV1
{
    readonly terminal_state: boolean;
}

export type FileDocumentV1_4 = Omit<FileDocumentV1, "file_version" | "state_machine"> &
{
    readonly file_version: "1.4.0";
    readonly state_machine: Omit<FileDocumentV1["state_machine"], "states"> &
    {
        readonly states: readonly FileStateDefinitionV1_4[];
    };
};
