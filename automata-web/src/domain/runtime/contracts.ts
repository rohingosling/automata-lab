...
// Captured execution policy and outcome belong to the session, independently of the model.

export interface RuntimeExecutionPolicy
{
    readonly enableTerminalStates: boolean;
}

export type RuntimeExecutionStatus =
    | { readonly kind: "active" }
    | { readonly kind: "terminated"; readonly reason: "terminal_state"; readonly state: string };
