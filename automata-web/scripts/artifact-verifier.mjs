...
// Both strict file validators and shared terminal preparation now ship in client and server.
// Console headers, resizing, and safe entity navigation add about 6 KB of client JavaScript.
// Allow that UI growth and its styles. The artifact allowance includes Windows text endings.
// Keep the worker and total JavaScript limits unchanged.
const BUNDLE_BUDGET_BYTES = Object.freeze ( {
    applicationJavascript: 1_108_000,
    chartRoutingWorker:       34_000,
    elkWorker:             1_500_000,
    serverWorker:            230_000,
    solverWorker:             32_000,
    stylesheet:               68_000,
    totalArtifact:         3_055_000,
    totalJavascript:       2_825_000,
} );
...
const FIXED_ARTIFACT_FILES = Object.freeze ( [
    ...
    { path: "icons/custom/32/state-machine-state-chart-palette-initial-state-indicator.svg", type: "svg" },
    { path: "icons/custom/32/state-machine-state-chart-palette-state.svg", type: "svg" },
    { path: "icons/custom/32/state-machine-state-chart-palette-terminal-state-indicator.svg", type: "svg" },
    { path: "icons/custom/32/state-machine-state-chart-palette-transition.svg", type: "svg" },
    ...
    { path: "schema/automata-lab-state-machine-1.1.0.schema.json", type: "json" },
    { path: "schema/automata-lab-state-machine-1.2.0.schema.json", type: "json" },
    { path: "schema/automata-lab-state-machine-1.3.0.schema.json", type: "json" },
    { path: "schema/automata-lab-state-machine-1.4.0.schema.json", type: "json" },
] );
