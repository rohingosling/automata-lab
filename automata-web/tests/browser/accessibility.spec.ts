...
//   a CSS viewport equivalent to a 1440-by-900 window at 200 percent zoom.
//
// /////////////////////////////////////////////////////////////////////////////////////////////////
...
test ( "AL-A11Y-001 and AL-A11Y-002 expose an accessible Editor and entity dialog", async ( { page } ) =>
{
    ...
    await expect ( page.getByRole ( "dialog", { name: /^(Add|Edit) State$/u } ) ).toBeVisible ();
...
test ( "AL-A11Y-003 remains operable in a 200-percent-equivalent CSS viewport", async ( { page } ) =>
{
