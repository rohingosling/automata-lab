...
describe ( "Phase 5 State Chart commands", () =>
{
    ...
    it ( "associates multiple states with terminal indicators and synchronizes semantic membership", () =>
    {
        // Initialize the local values needed by this operation.
        ...
        expect ( state.draft.stateMachine ).toEqual ( { ...stateMachine, states: stateMachine.states.map (
            declaration => ( { ...declaration, terminalState: true } ),
        ) } );
