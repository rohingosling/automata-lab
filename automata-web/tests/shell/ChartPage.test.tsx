...
function AttachmentHarness ( { keyboardReady = false }: { readonly keyboardReady?: boolean } )
{
    const [ editor, setEditor ] = useState ( () =>
    {
        ...
        return createDocumentEditorState ( {
            ...
            {
                ...draft.stateMachine,
                states: [ { terminalState: false, name: "A", description: "" }, { terminalState: false, name: "B", description: "" } ],
...
describe ( "State Chart page", () =>
{
    it ( "follows a state during keyboard movement before the geometry commit", () =>
    {
        ...
        expect ( Number.parseFloat ( screen.getByRole ( "button", { name: gripName } ).style.left ) ).toBeGreaterThan ( before );
        expect ( Number.parseFloat ( screen.getByRole ( "button", { name: gripName } ).style.top ) ).toBeCloseTo ( 100 );
        expect ( screen.queryByRole ( "dialog", { name: /^(Add|Edit) Transition$/u } ) ).toBeNull ();
    } );
    ...
    it.each ( [ false, true ] ) ( "completes keyboard attachments and permits escape: target-first=%s", async targetFirst =>
    {
        ...
        expect ( screen.getByRole ( "dialog", { name: /^(Add|Edit) Transition$/u } ) ).toBeVisible ();
        ...
        "completes attachments across revisions: target-first=%s self=%s", async ( targetFirst, selfTransition ) =>
    {
        ...
        const dialog = screen.getByRole ( "dialog", { name: /^(Add|Edit) Transition$/u } );
    ...
    it ( "preserves the viewport across state dragging, later edits, and preference projections without fitting", () =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states: [ { terminalState: false, name: "state_one", description: "One" } ],
            },
        };
    ...
    it ( "projects ordered duplicate action assignments into expanded state compartments", () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_idle", description: "Idle" } ],
    ...
    it ( "retains command-derived edges when React Flow reports a transient removal", () =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states:
                [
                    { terminalState: false, name: "state_one", description: "One" },
                    { terminalState: false, name: "state_two", description: "Two" },
                ],
    ...
    it ( "drops a generated state immediately and suppresses the post-drag click dialog", () =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states:
                [
                    { terminalState: false, name: "state_1", description: "One" },
                    { terminalState: false, name: "state_3", description: "Three" },
                ],
            },
        };
        const commandFactories: DocumentCommandFactory[] = [];
        ...
        expect ( screen.queryByRole ( "dialog", { name: /^(Add|Edit) State$/u } ) ).not.toBeInTheDocument ();
    ...
    it ( "keeps Transition click inert while drop creates a persistent draft without a dialog", async () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_alpha", description: "Alpha" } ],
                events: [ { name: "event_go", description: "Go" } ],
            },
        };
        const commandFactories: DocumentCommandFactory[] = [];
        ...
        expect ( screen.queryByRole ( "dialog", { name: /^(Add|Edit) Transition$/u } ) ).not.toBeInTheDocument ();
    ...
    it ( "moves either draft endpoint accessibly and snaps pointer or keyboard release to a state center", () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_snap", description: "Snap target" } ],
            },
        };
        const commandFactories: DocumentCommandFactory[] = [];
        ...
        "opens an ordered transition to %s with keyboard=%s", ( nextState, keyboard ) =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states:
                [
                    { terminalState: false, name: "state_source", description: "Source" },
                    { terminalState: false, name: "state_destination", description: "Destination" },
                ],
            },
        };
    ...
    it ( "drops an initial indicator above a state through one atomic placement command", () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_target", description: "Target" } ],
            },
        };
        const commandFactories: DocumentCommandFactory[] = [];
    ...
    it ( "deletes the focused draft instead of an unrelated pointer selection", () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_behind", description: "Behind the draft" } ],
            },
        };
        const commandFactories: DocumentCommandFactory[] = [];
    ...
    it ( "adds a visual terminal relation through a keyboard-opened accessible state-selection dialog", async () =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states:
                [
                    { terminalState: false, name: "state_available", description: "Available" },
                    { terminalState: false, name: "state_connected", description: "Connected" },
                ],
            },
        };
        const commandFactories: DocumentCommandFactory[] = [];
        ...
        expect ( within ( connectionDialog ).getByText (
            "Choose an unconnected source state to mark as terminal and connect to Terminal Indicator 7.",
        ) ).toBeVisible ();
    ...
    it ( "explains when every state already has a visual terminal relation", async () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_connected", description: "Connected" } ],
            },
        };
    ...
    it ( "disables and guards every Chart relation-add path at the exact relation limit", async () =>
    {
        ...
        const draft = {
            ...
            stateMachine:
            {
                ...
                states: [ { terminalState: false, name: "state_source", description: "Source" } ],
                transitionTable,
            },
        };
    ...
    it ( "never publishes a self-transition loop as an obstacle to any relation", () =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states:
                [
                    { terminalState: false, name: "state_a", description: "A" },
                    { terminalState: false, name: "state_b", description: "B" },
                    { terminalState: false, name: "state_loop", description: "Loop" },
                ],
                events: [ { name: "event_go", description: "Go" } ],
                transitionTable:
                [
    ...
    it ( "derives center-routed transition lanes and atomically reconnects semantic endpoints", () =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states:
                [
                    { terminalState: false, name: "state_idle", description: "Idle" },
                    { terminalState: false, name: "state_done", description: "Done" },
                ],
                events:
                [
    ...
    it ( "keeps four invisible technical handles for React Flow while routing remains center-derived", () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_handles", description: "Handles" } ],
            },
        };
    ...
    it ( "omits state validation markers and the redundant initial-state badge", () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: [ { terminalState: false, name: "state_initial", description: "Initial state" } ],
            },
        };
    ...
    it ( "does not restart a failed route when a parent rerenders with equivalent wrapping preferences", async () =>
    {
        ...
        const draft      = {
            ...
            stateMachine:
            {
                ...
                states:
                [
                    { terminalState: false, name: "state_off", description: "Off" },
                    { terminalState: false, name: "state_on", description: "On" },
                ],
    ...
    it ( "bounds the interactive surface and directs oversized models to the Editor", () =>
    {
        ...
        const draft      = {
            ...
            {
                ...emptyDraft.stateMachine,
                states: Array.from ( { length: 1_001 }, ( _value, index ) => ( { terminalState: false,
                    name: `state_${index}`,
                    description: "",
                } ) ),
            },
