...
{
    it ( "accepts only the complete reviewed 73-file fixture inventory", async () =>
    {
        // Initialize the local values needed by this operation.

        const result = await verifyFixture ();

        expect ( artifactInventory.fixedFiles ).toHaveLength ( 67 );
        expect ( artifactInventory.dynamicFiles ).toHaveLength ( 6 );
        expect ( result.fileCount ).toBe ( 73 );
    } );
