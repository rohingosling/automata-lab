...
{
    it ( "accepts only the complete reviewed 74-file fixture inventory", async () =>
    {
        // Initialize the local values needed by this operation.

        const result = await verifyFixture ();

        expect ( artifactInventory.fixedFiles ).toHaveLength ( 68 );
        expect ( artifactInventory.dynamicFiles ).toHaveLength ( 6 );
        expect ( result.fileCount ).toBe ( 74 );
    } );
