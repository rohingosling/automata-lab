...
<figure id="figure-ug-30" class="guide-figure">
    <a :href="guideScreenshot30" aria-label="Open Figure UG-30 at full size">
        <img :src="guideScreenshot30" alt="Appearance settings with Light selected, Blue title bars and application buttons, and disabled Gray Console color while matching is checked." width="900" height="410" loading="lazy" decoding="async">
    </a>
