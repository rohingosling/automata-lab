...
The dialog keeps its action buttons visible while longer settings pages scroll. At narrow widths, labels stack
above their values and controls fit the available width. Group-box titles use the same styling throughout the
application, including Settings and Page Setup.
