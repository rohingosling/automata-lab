...
schema matching its declared file version (`1.0.0`, `1.1.0`, `1.2.0`, `1.3.0`, or `1.4.0`). A project with no states or no initial state is permitted when everything else is sound; acknowledge the
...
Dense Charts can still take noticeably longer to route. Automata Lab retains a known dense-chart routing performance
