...
The States report includes **Terminal State** as **Yes** or **No**. Chart images and printing retain terminal
notation regardless of the Simulator preference, including Print before the first Chart visit. Reports capture
one document revision; the enablement preference, live termination status and traces are excluded.
