...
| `file_version` | Supported file-format version `1.0.0`, `1.1.0`, or `1.2.0`. |
...
`1.1.0`, and `1.2.0`. Save selects the minimum version required by the current Chart data:
...
| Free drafts without remembered event data, or no drafts | `1.0.0` |

Attachments, remembered events, and restoration positions survive Save/Open. Opening a file never completes a draft
