...
This documentation accompanies Automata Lab 1.5.0, built from the same source revision. The release simplifies
[Application Settings](./user-guide/application-settings), groups all settings controls, aligns checkbox labels,
and gives workspace and modal group boxes consistent rounded corners. It adds a default Solver results tab and
an independent Simulator trace-following preference. See
[Application Shell](./user-guide/application-shell#workspace) for the shared layout behavior and
[Configuration and Preferences](./developer-guide/configuration-and-preferences#presentation-spacing) for developer
spacing and corner-radius settings. Its JSON reader supports strict
