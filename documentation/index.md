...
This documentation accompanies Automata Lab 1.8.0, built from the same source revision. This version fixes
message, warning, and error badges that could become oval beside longer dialog text or in narrow windows.
The shared correction also protects Console badges.
