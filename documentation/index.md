...
This documentation describes the application built from the same source revision. Its JSON reader supports strict
file versions `1.0.0`, `1.1.0`, and `1.2.0`; Save chooses the minimum version required by the document. Application
