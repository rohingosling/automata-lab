...
| Version | Strict `1.0.0`, `1.1.0`, `1.2.0`, or `1.3.0`; independent of application and model versions. |
...
even when null. Save omits null optional references and uses `1.0.0` when neither extension is needed.
...
| Canonical document | Deterministic strict JSON in the minimum supported format required by its Chart data. |
