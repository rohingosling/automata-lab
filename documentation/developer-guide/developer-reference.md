...
| Version | Strict `1.0.0`, `1.1.0`, or `1.2.0`; independent of application and model versions. |
...
remembered event/order metadata requires `1.2.0`, even when both ends are free. Earlier formats reject later fields
