...
The main application JavaScript budget is 1,005,000 uncompressed bytes. This project-owned build safeguard fails
when the emitted file exceeds its allowance; it is separate from browser capabilities and compressed transfer size.
Release 1.5.0 increases this allowance by 5,000 bytes for the added settings functionality. Worker, CSS, and aggregate
budgets retain their existing limits; the total JavaScript allowance remains 2,700,000 bytes. The executable authority
is `scripts/artifact-verifier.mjs`.
