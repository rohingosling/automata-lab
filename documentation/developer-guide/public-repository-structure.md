...
| Path | Content |
|---|---|
| `examples/state-machine-light-switch.json` | Legacy `1.0.0` migration example and built-in server seed. |
| `examples/state-machine-terminal-states.json` | Equivalent current `1.4.0` example with explicit terminal flags. |
