...
`fileVersionForDocument` selector as Save, including `1.1.0` attachments and `1.2.0` remembered metadata. The Chart
Projection lists remembered events and attached state names alongside endpoint coordinates. Capturing or printing a
