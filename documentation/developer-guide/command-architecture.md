...
history infrastructure. Eventless drafts open configuration only after the second attachment or explicit editing;
...
entire drop. Passive Open, layout, Undo/Redo, and rerenders never trigger restoration or configuration.
